...
// 	{
//       var url = "http://localhost/jiaolianyuan/index.php/Home/Register/checkPhone?phoneNo="+phoneNo;
//       document.getElementById("checkRemind").value="";
      
//       getJson(url,function (result) {
// //  	alert(result);
//           document.getElementById("checkRemind").innerHTML = result;  
//       })
...
<script type="text/javascript">
  //发送短信
    function sendPhoneMessage()
    {
    	...
    	document.getElementById("getPhoneCodeResult").innerHTML = "发送中...";  //因为发送时间比较长，所以先显示发送中
    	var url = "localhost/jiaolianyuan/index.php/Home/Register/sendPhoneMessage?phoneNo="+phoneNo;
    	getJson(url,function (result) {
       alert(result);
       document.getElementById("getPhoneCodeResult").innerHTML = "";   //去点发送中字样
    })
    }
 </script>
	...
	<div id="bg-pic">
    	<div id="register">
        	<div class="register-form">
                <h2>用户注册</h2>
                <b>已有账号>></b><a target="_blank" href="/jiaolianyuan/index.php/Home/Login/login" >在线登录</a>
               
               <button id="codes-btn"  name="get-codes" onclick="sendPhoneMessage()">获取验证码</button>  <!--不能放在form表单，不然会做提交操作-->
              <!--显示发送中字样-->
              ...
              <form id="" enctype="multipart/form-data" method="post" action="/jiaolianyuan/index.php/Home/Register/do_register">
                     <div class="register-box">
                       ...
                       <!--  <p id = "checkRemind" ></p> -->  <!--onblur = "checkPhone(this.value)"放手机号码是否已被注册提醒-->
                     </div>
                    ...
                    <br />
                     ...
                     <div class="codes-box">
                        <input class="codes" id="codes" type="text" name="verify" placeholder="验证码"/>
                     </div>
                     <div class="codes-box">
                        <input class="codes" id="mes-codes" type="text" name="mes-codes" placeholder="短信验证码"/>
                        <!--获取短信验证码按钮要放外面-->
                        <!--<button id="codes-btn"  name="get-codes" onclick="sendPhoneMessage()">获取验证码</button>-->
                     </div>
                     <div class="register-box">
